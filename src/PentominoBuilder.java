...
public class PentominoBuilder {
    ...
    /**
     * Rotate the matrix x times over 90 degrees Assume that the matrix is a square!
    ...
    /**
     * Flip the matrix horizontally It makes a copy, the input matrix stays
     * unchanged
     * 
     * @param data a matrix
     * @return the flipped matrix
    ...
    /**
     * Expands a smaller than size*size matrix to a size*size matrix It makes a
     * copy, the input matrix stays unchanged Assume that the input is smaller than
     * size!!
     * 
     * @param data: a matrix
