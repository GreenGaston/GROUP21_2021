 ...
 * a CSV
 * Information abpout the structure of the CSV file (also included in
 * pentomino.csv.README)
 * Each line in the CSV file defines one permutation of a pentomino.
 * - The first number is the ID for a pentomino, from 0 to 11.
 * - The second number is the index of the permutation (rotation, flip, etc.),
 * between 0 to 7.
...
public class PentominoDatabase {
    ...
    public static int[][][][] data = loadData("src/main/java/com/example/Application/pentominos.csv");
